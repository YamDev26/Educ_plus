<div class="sidenav-menu">
    ...
    <div data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a data-bs-toggle="collapse" href="#sidebarParametres" aria-expanded="false" aria-controls="sidebarParametres" class="side-nav-link">
                    <span class="menu-icon"><i class="ti ti-basket-filled"></i></span>
                    <span class="menu-text"> Parametres </span>
                    <span class="menu-arrow"></span>
                </a>
                <div class="collapse" id="sidebarParametres">
                    <ul class="sub-menu">
                        <li class="side-nav-item {{ request()->is('param/cutting/*') ? 'active' : '' }}">
                            <a href="{{ route('cutting.index') }}" class="side-nav-link {{ request()->is('param/cutting/*') ? 'active' : '' }}">
                                <span class="menu-text">Cutting</span>
                            </a>
                        </li>
                        <li class="side-nav-item {{ request()->is('param/school_year/*') ? 'active' : '' }}">
                            <a href="{{ route('year.index') }}" class="side-nav-link {{ request()->is('param/school_year/*') ? 'active' : '' }}">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarInvoice">
                    <ul class="sub-menu">
                        <li class="side-nav-item {{ request()->is('config/slot_time/*') ? 'active' : '' }}">
                            <a href="{{ route('slot.index') }}" class="side-nav-link {{ request()->is('config/slot_time/*') ? 'active' : '' }}">
                                <span class="menu-text">Slot time</span>
                            </a>
                        </li>
                        <li class="side-nav-item {{ request()->is('config/level/*') ? 'active' : '' }}">
                            <a href="{{ route('level.index') }}" class="side-nav-link {{ request()->is('config/level/*') ? 'active' : '' }}">
                                <span class="menu-text">Level</span>
                            </a>
                        </li>
                        <li class="side-nav-item {{ request()->is('config/*') ? 'show' : '' }}">
                            <a href="{{ route('school.index') }}" class="side-nav-link {{ request()->is('config/*') ? 'show' : '' }}">
