<div class="row">
    <div class="col-lg-6 offset-lg-3">
        ...
        <div class="alert bg-success border-0 alert-dismissible fade show py-0">
        ...
        <div class="alert  bg-danger border-0 alert-dismissible fade show py-0">
            <div class="d-flex align-items-center">
        ...
        <div class="alert bg-info border-0 alert-dismissible fade show py-0">
            <div class="d-flex align-items-center">
        ...
        <div class="alert bg-warning border-0 alert-dismissible fade show py-0">
            <div class="d-flex align-items-center">
