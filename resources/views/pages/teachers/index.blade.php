            ...
            <div class="card radius-10 w-100">
                <div class="card-header d-flex justify-content-between flex-wrap gap-2 pt-3 pb-1 mb-0">
                    ...
                    <span style="float: right; ">
                        <a href="{{ route('teacher.create') }}" class="btn btn-outline-light py-0 px-2 mb-1" title="Add New Student" style="border: none; border-radius: 3px">
                            ...
                            <div class="table-responsive mt-4">
                                ...
                                <thead>
                                    <tr class="table-dark">
                                        ...
                                        <th class="text-center py-2" style="width: 20%; border: 1px solid grey;">Actions</th>
                                    </tr>
                                </thead>
                                <!-- Content  -->
                                </table>
