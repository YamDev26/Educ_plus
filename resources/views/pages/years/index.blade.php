...
<div class="row g-3">
    <div class="col-12">
        <div class="card" id="TableCrmRecentLeads" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;status&quot;],&quot;page&quot;:8,&quot;pagination&quot;:true}">
            <div class="card-header d-flex flex-between-center flex-wrap gap-2 pt-3">
                <h5 class="mb-0">Gestion des Années</h5>
                <div id="table-recent-leads-actions">
                    <button class="btn btn-falcon-default btn-sm mb-2" style="float: left">Add Year</button>
                </div>
            </div>
            <hr class="my-2">
            <div class="card-body pt-0">
                  <div class="tab-content">
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-d62f6c5a-6780-442a-afb7-65ac3f8cd213" id="dom-d62f6c5a-6780-442a-afb7-65ac3f8cd213">
